...
topdir = .
BUILD_DIR = /home/jvanriper/jvanriper/bash/bash-4.4.18-1
top_builddir = /home/jvanriper/jvanriper/bash/bash-4.4.18-1
srcdir = .
...
LOCAL_LIBS = 
LIBS = $(BUILTINS_LIB) $(LIBRARIES) -ldl  -pthread -lrt
LIBS_FOR_BUILD =
...
CCFLAGS = $(BASE_CCFLAGS) $(CPPFLAGS) $(CFLAGS) $(CDEFS)
