...
topdir = .
BUILD_DIR = /home/jvanriper/jvanriper/bash/bash-5.0
top_builddir = /home/jvanriper/jvanriper/bash/bash-5.0
srcdir = .
...
LOCAL_LIBS = 
LIBS = $(BUILTINS_LIB) $(LIBRARIES) -pthread -lrt -ldl 
LIBS_FOR_BUILD =
...
CCFLAGS = $(ADDON_CFLAGS) $(BASE_CCFLAGS) ${PROFILE_FLAGS} $(CPPFLAGS) $(CFLAGS) $(CDEFS)
...
CSOURCES = audit_cmd.c shell.c eval.c parse.y general.c make_cmd.c print_cmd.c y.tab.c \
...
HSOURCES = audit_cmd.h shell.h flags.h trap.h hashcmd.h hashlib.h jobs.h builtins.h \
...
OBJECTS	 = audit_cmd.o shell.o eval.o y.tab.o general.o make_cmd.o print_cmd.o $(GLOBO) \
