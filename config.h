...
/* Define if you want to support auditing. */
#define AUDIT_BASH 1

/* Define if auditing outputs to /tmp files. */
/* #undef AUDIT_FILE_OUTPUT */

/* Define if auditing outputs to shared object. */
#define AUDIT_SO_OUTPUT 1
